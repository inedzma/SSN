                ...
                <Layout className="pt-30">
                    ...
                    <section className="bg-white dark:bg-gray-900">
                        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-center text-textBoja dark:text-white">Kontaktirajte
                                nas</h2>
                            <p className="mb-8 lg:mb-16 font-light text-center text-textBoja dark:text-gray-400 sm:text-xl">Imate
                            ...
                            <form action="#" className="space-y-8">
                                <div>
                                    <label htmlFor="email"
                                           className="block mb-2 text-sm font-medium text-textBoja dark:text-gray-300">E-mail</label>
                                    <input ref={emailRef} type="email" id="email"
                                           className="p-3 block w-full rounded-md border-0 py-1.5 text-textBoja shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:bg-gray-700 dark:ring-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-indigo-600"
                                           placeholder="imeprezime@gmail.com" required/>
                                </div>
                                <div>
                                    <label htmlFor="subject"
                                           className="block mb-2 text-sm font-medium text-textBoja dark:text-gray-300">Predmet</label>
                                ...
                                <div className="sm:col-span-2">
                                    <label htmlFor="message"
                                           className="block mb-2 text-sm font-medium text-textBoja dark:text-gray-400">Poruka</label>
                                    <textarea ref={porukaRef} id="message" rows="6"
                                              className="p-3 block w-full rounded-md border-0 py-1.5 text-textBoja shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:bg-gray-700 dark:ring-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-indigo-600"
                                              placeholder="Napišite poruku..."></textarea>
                                </div>
                                <button className="py-3 px-5 text-lg bg-Dugme hover:bg-customColor font-medium text-center rounded-lg dugme">Pošalji
                                </button>
                            </form>
                        </div>
                    </section>
