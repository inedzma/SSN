...
export const Pocetna = () => {
    ...
    return (
        <Layout>
            ...
            <h1 className="text-4xl font-bold tracking-tight text-gray-700 sm:text-6xl text-black"> Uživajte u novoj kolekciji!
            </h1>
            <p className="mt-4 text-xl text-gray-500">
                Otkrijte našu najnoviju kolekciju nakita inspirisanu ljetnim sjajem i prirodnim ljepotama. Bez obzira na priliku, naši jedinstveni dizajni savršeno će upotpuniti vaš stil!
            </p>
            </div>
            <div>
            <div className="mt-10">
    ...
    <div className="bg-gray-100 ">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-customColor2 sm:text-4xl">Prijavi se na naš newsletter!</h2>
            <p className="mt-4 text-lg leading-8 text-gray-300"> Budite uvijek u toku sa najnovijim vijestima, ekskluzivnim ponudama i posebnim događajima. Naš informativni bilten donosi vam redovne ažuriranja direktno u vaš inbox, tako da nikada ne propustite važnu informaciju.
            </p>
            ...
            <dd className="mt-2 leading-7 text-gray-400">
                Samo pretplatnici našeg newslettera imaju pristup posebnim popustima i promocijama koje nisu dostupne drugima.
            </dd>
            </div>
            <div className="flex flex-col items-start">
            <div className="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
            ...
            <dd className="mt-2 leading-7 text-gray-400">
                Obećavamo da ćemo vam slati samo kvalitetan sadržaj. Naš cilj je da vas informišemo, a ne da vas zatrpamo nepotrebnim porukama.
            </dd>
            </div>
            </dl>
            </div>
