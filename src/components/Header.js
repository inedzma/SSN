...
export const Header = ({onSearch}) => {
    ...
    function handleKategorijaClick() {
    ...
    return (
        <>
            <nav className="bg-customColor border-gray-200 sticky top-0 z-50">
                ...
                <button onClick={handleOnClick2} data-collapse-toggle="default-sidebar" type="button"
                    ...
                    <div className="flex md:order-2 ">
                        <div className="relative hidden md:block md:mr-4">
                            ...
                            <input type="text" id="search-navbar_2" value={searchTerm} onChange={handleSearch}
                                      onKeyPress={handleKeyPress}
                        ...
                        <button type="button" className="pl-5 pr-5 inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600 md:ml-4">
                    ...
                    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
                        ...
                        <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            ...
                            <li>
                                <button onClick={handleKategorijaClick} id="mega-menu-full-dropdown-button"
